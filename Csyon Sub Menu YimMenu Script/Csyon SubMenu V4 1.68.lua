...
CSYON = gui.get_tab("** CSYON SubMenu 1.68 By CSYON**")

CSYON:add_text("Game Build Version 3179⚠️ ✅ v5")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Self = CSYON:add_tab("Self Menu")
...
CSYON3 = CSYON:add_tab("Unlocker Menu 1.68 ")
...
CSU = FAUT:add_tab("Character Stats")
...
wasabi_words = FAUT:add_tab("Unlock All Menu By ShinyWasabi") --WasabiWords™️
...
Me:add_text("Credits: MOHA, gir489")
...
CPVMenu = CSYONCAYO:add_tab("Size/Value Editor")
