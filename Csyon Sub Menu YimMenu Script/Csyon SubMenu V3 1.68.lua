...
MenuTab = gui.get_tab("GUI_TAB_NETWORK"):add_tab("Casino") --IT'S NOT AL ANYMORE! IT'S DUNK! 
blackjack_cards         = 112
...
--------------------------------------------------------------------------------------------------------------------------------
local CSYONRISKYMONEYOPTIONS = MenuTab.add_submenu("💵(Risky Money Options)🤑")
CSYONRISKYMONEYOPTIONS:add_action("$$$ 💵Insane 1 Mil Loop💵 $$$", function()
...
CSYONRISKYMONEYOPTIONS:add_action("$$$ 💵Get 750k💵 $$$", function()
    globals.set_int(1969112, 2)
    sleep(50)
    globals.set_int(1969112, 0)
end)

CSYONRISKYMONEYOPTIONS:add_action("$$$ 💵Get 500k💵 $$$", function()
...
CSYON3 = MenuTab:add_tab("✨ Unlock Misc")

-----------------------------------------------------------------------------------

CSYON3:add_button("Unlock GunVan RailGun", function()
globals.set_int(262145 + 33840 + 3, -22923932) ----- RailGun
end)

---------------------------------------------------------------------------------------------------------------------------------
--Thanks for this Script share to my Bro @Yimura
...
CSYON4 = MenuTab:add_tab("🎴Events")

----------------------------------------------------------------------------------------------------------------------------------

CSYONS4 = CSYON4:add_tab("Snow Toggle Menu")
...
CSYONMW29 = CSYON4:add_tab("Unlock Weapon MW29")
...
CSYONMW29:add_checkbox("Is The Event Enabled", function()
...
CSYONMW29:add_button("Teleport NO1", function()
	 teleport_myself(-926.20, -501.58, 35.79)
 end)

CSYONMW29:add_button("Teleport NO2", function()
	 teleport_myself(-894.06, -448.18, 174.15)
 end)

----------------------------------------------------------------------------------------------------------------------------------

CSYONMW29README = CSYONMW29:add_tab("Read Me")

CSYONMW29README:add_button("==============================", function() end)

CSYONMW29README:add_button("     Instructions", function() end)

CSYONMW29README:add_button("==============================", function() end)

CSYONMW29README:add_button("First Go Public Session", function() end)

CSYONMW29README:add_button("Then Teleport  To  Place NO1", function() end)

CSYONMW29README:add_button("Then Active Enable Weazel Bank", function() end)

CSYONMW29README:add_button("Shootout Event", function() end)

CSYONMW29README:add_button("Then Stand AFK And Waiting For 20m", function() end)

CSYONMW29README:add_button("After That, From 20:00 To 06:00, Wait", function() end)
 
CSYONMW29README:add_button("For", function() end)

CSYONMW29README:add_button("The Appearance Of a Red Marker", function() end)

CSYONMW29README:add_button("Use The Teleport NO2 To Get On Top Of", function() end)

CSYONMW29README:add_button("The Building To Get The MW29", function() end)

CSYONMW29README:add_button("If It Does Not Appear", function() end)

CSYONMW29README:add_button("Then Change The Session", function() end)


----------------------------------------------------------------------------------------------------------------------------------

CSYONGOOCHLMAO = CSYON4:add_tab("Trigger Gooch Event")
...
---Full Account Unlocker Tool---
	...
	CSYON25 = MenuTab:add_tab("🎮Unlock Alls")
				   
--Character's Stats--

	CSYONS25 = CSYON25:add_tab("Character's Stats")
	
	CSYON26 = CSYONS25:add_tab("Achievements")
			
			Acv0 = false
			AG = 4542602 + 1
		local function AchUnlock()
		while Acv0 == true do for i = 1, 78 do globals.set_int(4542602 + 1 , i) end end end
	CSYON26:add_checkbox("Unlock All", function() return Acv0 end, function() Acv0 = not Acv0 AchUnlock(Acv0) end)
											 
	CSYONS26 = CSYON26:add_tab("Unlock All Achievements")
	
	CSYONS26:add_button("Welcome to Los Santos", function() globals.set_int(AG, 1) end)
	CSYONS26:add_button("A Friendship Resurrected", function() globals.set_int(AG, 2) end)
	CSYONS26:add_button("A Fair Day's Pay", function() globals.set_int(AG, 3) end)
	CSYONS26:add_button("The Moment of Truth", function() globals.set_int(AG, 4) end)
	CSYONS26:add_button("To Live or Die in Los Santos", function() globals.set_int(AG, 5) end)
	CSYONS26:add_button("Diamond Hard", function() globals.set_int(AG, 6) end)
	CSYONS26:add_button("Subversive", function() globals.set_int(AG, 7) end)
	CSYONS26:add_button("Blitzed", function() globals.set_int(AG, 8) end)
	CSYONS26:add_button("Small Town, Big Job", function() globals.set_int(AG, 9) end)
	CSYONS26:add_button("The Government Gimps", function() globals.set_int(AG, 10) end)
	CSYONS26:add_button("The Big One!", function() globals.set_int(AG, 11) end)
	CSYONS26:add_button("Solid Gold, Baby!", function() globals.set_int(AG, 12) end)
	CSYONS26:add_button("Career Criminal", function() globals.set_int(AG, 13) end)
	CSYONS26:add_button("San Andreas Sightseer", function() globals.set_int(AG, 14) end)
	CSYONS26:add_button("All's Fare in Love and War", function() globals.set_int(AG, 15) end)
	CSYONS26:add_button("TP Industries Arms Race", function() globals.set_int(AG, 16) end)
	CSYONS26:add_button("Multi-Disciplined", function() globals.set_int(AG, 17) end)
	CSYONS26:add_button("From Beyond the Stars", function() globals.set_int(AG, 18) end)
	CSYONS26:add_button("A Mystery, Solved", function() globals.set_int(AG, 19) end)
	CSYONS26:add_button("Waste Management", function() globals.set_int(AG, 20) end)
	CSYONS26:add_button("Red Mist", function() globals.set_int(AG, 21) end)
	CSYONS26:add_button("Show Off", function() globals.set_int(AG, 22) end)
	CSYONS26:add_button("Kifflom!", function() globals.set_int(AG, 23) end)
	CSYONS26:add_button("Three Man Army", function() globals.set_int(AG, 24) end)
	CSYONS26:add_button("Out of Your Depth", function() globals.set_int(AG, 25) end)
	CSYONS26:add_button("Altruist Acolyte", function() globals.set_int(AG, 26) end)
	CSYONS26:add_button("A Lot of Cheddar", function() globals.set_int(AG, 27) end)
	CSYONS26:add_button("Trading Pure Alpha", function() globals.set_int(AG, 28) end)
	CSYONS26:add_button("Pimp My Sidearm", function() globals.set_int(AG, 29) end)
	CSYONS26:add_button("Wanted:Alive Or Alive", function() globals.set_int(AG, 30) end)
	CSYONS26:add_button("Los Santos Customs", function() globals.set_int(AG, 31) end)
	CSYONS26:add_button("Close Shave", function() globals.set_int(AG, 32) end)
	CSYONS26:add_button("Off the Plane", function() globals.set_int(AG, 33) end)
	CSYONS26:add_button("Three-Bit Gangster", function() globals.set_int(AG, 34) end)
	CSYONS26:add_button("Making Moves", function() globals.set_int(AG, 35) end)
	CSYONS26:add_button("Above the Law", function() globals.set_int(AG, 36) end)
	CSYONS26:add_button("Numero Uno", function() globals.set_int(AG, 37) end)
	CSYONS26:add_button("The Midnight Club", function() globals.set_int(AG, 38) end)
	CSYONS26:add_button("Unnatural Selection", function() globals.set_int(AG, 39) end)
	CSYONS26:add_button("Backseat Driver", function() globals.set_int(AG, 40) end)
	CSYONS26:add_button("Run Like The Wind", function() globals.set_int(AG, 41) end)
	CSYONS26:add_button("Clean Sweep", function() globals.set_int(AG, 42) end)
	CSYONS26:add_button("Decorated", function() globals.set_int(AG, 43) end)
	CSYONS26:add_button("Stick Up Kid", function() globals.set_int(AG, 44) end)
	CSYONS26:add_button("Enjoy Your Stay", function() globals.set_int(AG, 45) end)
	CSYONS26:add_button("Crew Cut", function() globals.set_int(AG, 46) end)
	CSYONS26:add_button("Full Refund", function() globals.set_int(AG, 47) end)
	CSYONS26:add_button("Dialling Digits", function() globals.set_int(AG, 48) end)
	CSYONS26:add_button("American Dream", function() globals.set_int(AG, 49) end)
	CSYONS26:add_button("A New Perspective", function() globals.set_int(AG, 50) end)
	CSYONS26:add_button("Be Prepared", function() globals.set_int(AG, 51) end)
	CSYONS26:add_button("In the Name of Science", function() globals.set_int(AG, 52) end)
	CSYONS26:add_button("Dead Presidents", function() globals.set_int(AG, 53) end)
	CSYONS26:add_button("Parole Day", function() globals.set_int(AG, 54) end)
	CSYONS26:add_button("Shot Caller", function() globals.set_int(AG, 55) end)
	CSYONS26:add_button("Four Way", function() globals.set_int(AG, 56) end)
	CSYONS26:add_button("Live a Little", function() globals.set_int(AG, 57) end)
	CSYONS26:add_button("Can't Touch This", function() globals.set_int(AG, 58) end)
	CSYONS26:add_button("Mastermind", function() globals.set_int(AG, 59) end)
	CSYONS26:add_button("Vinewood Visionary", function() globals.set_int(AG, 60) end)
	CSYONS26:add_button("Majestic", function() globals.set_int(AG, 61) end)
	CSYONS26:add_button("Humans of Los Santos", function() globals.set_int(AG, 62) end)
	CSYONS26:add_button("First Time Director", function() globals.set_int(AG, 63) end)
	CSYONS26:add_button("Animal Lover", function() globals.set_int(AG, 64) end)
	CSYONS26:add_button("Ensemble Piece", function() globals.set_int(AG, 65) end)
	CSYONS26:add_button("Cult Movie", function() globals.set_int(AG, 66) end)
	CSYONS26:add_button("Location Scout", function() globals.set_int(AG, 67) end)
	CSYONS26:add_button("Method Actor", function() globals.set_int(AG, 68) end)
	CSYONS26:add_button("Cryptozoologist", function() globals.set_int(AG, 69) end)
	CSYONS26:add_button("Getting Started", function() globals.set_int(AG, 70) end)
	CSYONS26:add_button("The Data Breaches", function() globals.set_int(AG, 71) end)
	CSYONS26:add_button("The Bogdan Problem", function() globals.set_int(AG, 72) end)
	CSYONS26:add_button("The Doomsday Scenario", function() globals.set_int(AG, 73) end)
	CSYONS26:add_button("A World Worth Saving", function() globals.set_int(AG, 74) end)
	CSYONS26:add_button("Orbital Obliteration", function() globals.set_int(AG, 75) end)
	CSYONS26:add_button("Elitist", function() globals.set_int(AG, 76) end)
	CSYONS26:add_button("Masterminds", function() globals.set_int(AG, 77) end)
	
	CSYON26:add_button("", function() end)
	
	CSYONS27 = CSYON26:add_tab("Read Me")
	
	CSYONS27:add_button("                         Unlock All:", function() end)
	CSYONS27:add_button(" Unlocks all achievements auto; ≈10 mins;", function() end)
	CSYONS27:add_button("               to turn off the option,", function() end)
	CSYONS27:add_button("     close the menu via «Menu Settings»", function() end)
	
-----------------------------------------------------------------------------------------------------------------------------------------

      CSYON29 = CSYONS25:add_tab("🎴 Collections")
	
	CSYONS29 = CSYON29:add_tab("Unlock All (Temporarily)")
	
	CSYONS29:add_button("Action Figures", function() globals.set_int(2764906 + 209 , 100) end)
	CSYONS29:add_button("Movie Props", function() globals.set_int(2764906 + 494 , 10) end)
	CSYONS29:add_button("Playing Cards", function() globals.set_int(2764906 + 210 , 54) end)
	CSYONS29:add_button("Signal Jammers", function() globals.set_int(2764906 + 211 , 50) end)
      CSYONS29:add_button("LD Organics", function() globals.set_int(2764906 + 593 , 100) end)
      CSYONS29:add_button("Buried Stashs", function() globals.set_int(2764906 + 553 , 10) end)
      CSYONS29:add_button("Jack o Lantern", function() globals.set_int(2764906 + 591 , 10) end)
      CSYONS29:add_button("Hidden Caches", function() globals.set_int(2764906 + 504 , 10) end)
      CSYONS29:add_button("Treasure Chests", function() globals.set_int(2764906 + 506 , 30) end)
	
	CSYONS30 = CSYON29:add_tab("Unlock All (Permanently)")
	
	CSYONS30:add_button("Action Figures", function() globals.set_int(2764906 + 209 , 99) end)
	CSYONS30:add_button("Movie Props", function() globals.set_int(2764906 + 494 , 9) end)
	CSYONS30:add_button("Playing Cards", function() globals.set_int(2764906 + 210 , 53) end)
	CSYONS30:add_button("Signal Jammers", function() globals.set_int(2764906 + 211 , 49) end)
      CSYONS30:add_button("LD Organics", function() globals.set_int(2764906 + 593 , 99) end)
      CSYONS30:add_button("Buried Stashs", function() globals.set_int(2764906 + 553 , 9) end)
      CSYONS30:add_button("Jack o Lantern", function() globals.set_int(2764906 + 591 , 9) end)
      CSYONS30:add_button("Hidden Caches", function() globals.set_int(2764906 + 504 , 9) end)
	CSYONS30:add_button("Treasure Chests", function() globals.set_int(2764906 + 506 , 29) end)

	CSYONS30:add_button("", function() end)
	
	CSYONNote = CSYONS30:add_tab("Read Me")
	
	CSYONNote:add_button("     First, find the item you want, select", function() end)
	CSYONNote:add_button("    an option, and then pick up the item", function() end)
...
-------------------------------------------------------------------------------------------------------------------------------------------
     ...
     CSYON32 = MenuTab:add_tab("LSCM Unlocker Menu")


CSYON32:add_button("LSCM Prize Ride Unlock", function() stats.set_bool(MPX .. "CARMEET_PV_CHLLGE_CMPLT", true) end)

--------------------------------------------------------------------------------------------------------------------------------------------
	
	CSYONNOTES = MenuTab:add_tab("Read Me")

---------------------------------------------------------------------------------------------------------------------------------------------
	
	CSYONNOTES:add_button("                Unlock «Change Gender»:", function() end)
	CSYONNOTES:add_button("     Unlocks «Change Gender» option while", function() end)
	CSYONNOTES:add_button("                editing your character", function() end)
...
CSYON7 = MenuTab:add_tab("Warehouse Money Methode")

CSYON7:add_checkbox("Start Ceo Banager",
  function()
...
-------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------This Feature Improved By ----------AKA CSYON  If-------------- -You Take It Without Credits Then You Are A c/p------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
CSYON7N:add_button("     Ceo Crates Method       ", function() end)
CSYON7N:add_button("   First Enter Your Warehouse   ", function() end)
CSYON7N:add_button("Next Start Ultimate Money Manager       ", function() end)
CSYON7N:add_button("     Finally Active The Auto Sell Afk       ", function() end)
CSYON7N:add_button("", function() end)
CSYON7N:add_button("https://discord.gg/JaCvtj6yQK", function() end)

-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

---------------------------------------------------------------------------------------------------------------------------------

CSYON1 = MenuTab:add_tab("**🔽 Credits 🔼**")

--------------------------------------------------------------------------------------------------------------
CSYON1:add_button("---Kiddion---", function() end)

CSYON1:add_button("---Ryze---", function() end)

CSYON1:add_button("---ΞΛZТΞΛ#3171/SLON---", function() end)

CSYON1:add_button("---MxGta#1746---", function() end)

CSYON1:add_button("---Apple Vegas---", function() end)

CSYON1:add_button("---CSYON---", function() end)

CSYON1:add_button("---csyon_racoon---", function() end)

CSYON1:add_button("Discord Server For Any Help", function() end)

CSYON1:add_button("https://discord.gg/JaCvtj6yQK", function() end)
   ...
   CC:::::::::::::::C r:::::r             e::::::::eeeeeeee   d:::::::::::::::::di::::::i      tt::::::::::::::ts::::::::::::::s 
     CCC::::::::::::C r:::::r              ee:::::::::::::e    d:::::::::ddd::::di::::::i        tt:::::::::::tt s:::::::::::ss  
        CCCCCCCCCCCCC rrrrrrr                eeeeeeeeeeeeee     ddddddddd   dddddiiiiiiii          ttttttttttt    sssssssssss    
          ...
          Big Thanks To All in Credits for Allowing use he's Resources <3
                 		 -> B!G Menu by BIGBOOM  
                         -> CSYON SubMenu 1.67 by CSYON                                                                                                                       
                         -> Ultimate Controller  
                         -> Simple Manager by SLON                                                                                                       
                         -> RyzeKiddions.lua by Pichocles#0427  
						 -> WareHouse Money Methode - Thanks Bro L7NEG <3 
                         -> API - Thanks Bro Kiddion <3 
